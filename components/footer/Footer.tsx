      ...
      <div className="max-w-[85rem] mx-auto">
        <div className="flex items-center flex-col md:flex-row md:justify-between gap-12 relative z-10">
          ...
          <div className="md:text-end flex flex-row gap-3">
            ...
            <a
              className="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-color hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none "
              href="https://www.youtube.com/@ArcSynergyLimited"
            >
              <svg
                width="24"
                height="25"
              ...
              >
                <path
                  d="M21.5931 7.63959C21.4792 7.21699 21.2566 6.8316 20.9475 6.52176C20.6383 6.21192 20.2534 5.98845 19.8311 5.87359C18.2651 5.44359 12.0001 5.43659 12.0001 5.43659C12.0001 5.43659 5.73609 5.42959 4.16909 5.84059C3.74701 5.96074 3.36291 6.18737 3.05365 6.49873C2.7444 6.81008 2.52037 7.19571 2.40309 7.61859C1.99009 9.18459 1.98609 12.4326 1.98609 12.4326C1.98609 12.4326 1.98209 15.6966 2.39209 17.2466C2.62209 18.1036 3.29709 18.7806 4.15509 19.0116C5.73709 19.4416 11.9851 19.4486 11.9851 19.4486C11.9851 19.4486 18.2501 19.4556 19.8161 19.0456C20.2386 18.9309 20.6238 18.708 20.9337 18.3988C21.2436 18.0896 21.4675 17.7048 21.5831 17.2826C21.9971 15.7176 22.0001 12.4706 22.0001 12.4706C22.0001 12.4706 22.0201 9.20559 21.5931 7.63959ZM9.99609 15.4416L10.0011 9.44159L15.2081 12.4466L9.99609 15.4416Z"
                  fill="#2A2B6A"
                />
              </svg>
            </a>
